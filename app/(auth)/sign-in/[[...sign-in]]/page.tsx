  ...
  <div className="lg:grid lg:min-h-screen lg:grid-cols-12">
    <section className="relative flex h-32 items-end bg-gray-900 lg:col-span-5 lg:h-full xl:col-span-6">
      ...
      <div className="hidden lg:relative lg:block lg:p-12">
        ...
        Welcome to Prep Pulse 🦑
        </h2>

        <p className="mt-4 leading-relaxed text-white/90">
        Prep Pulse is an AI-powered mock interview platform that simulates realistic interview scenarios. It provides instant feedback and personalized coaching to help users improve their responses and boost their confidence for real interviews.
        </p>
      </div>
    </section>
    ...
    >
      ...
      <SignIn.Step name="start" className="w-full space-y-6 rounded-2xl px-4 py-10 sm:w-96 sm:px-8">
        <header className="text-center">
          ...
          <h1 className="mt-4 text-xl font-medium tracking-tight text-neutral-950">Sign in to Prep Pulse</h1>
        </header>
